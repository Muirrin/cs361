...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI(); // prints "EMPLOYEE" because that is the printed line in the Employee file
		// emp3.getHourlyRate(); // returns syntax error because getHourlyRate() is not an Employee method

		// TODO To complete
		// Add the condition that test that emp3 is an instance of part time employee at
		// this time
		
		 if (emp3.getWhoAmI().equals("PART TIME EMPLOYEE")) {
		...
		// because the instruction attempts to cast an object to an incompatable subclass
